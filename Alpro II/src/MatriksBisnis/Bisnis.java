...
public class Bisnis {
	...
	void OutputBisnis() {
		...
		switch(Jenis) {
		case 1:
			System.out.println("Jenis: Bengkel");
			break;
		case 2:
			System.out.println("Jenis: Kafe");
			break;
		case 3:
			System.out.println("Jenis: Pets");
			break;
		case 4:
			System.out.println("Jenis: Resto");
			break;
		case 5:
			System.out.println("Jenis: Toko Sembako");
			break;
		}
